...
export const SITE_CONFIG = {
  ...
  title: "Gail Maat",
  description: "A creative showcase of my work, skills, and passion for design and development.",
  author: "Gail",
  
  // Contact information
  email: "hello@gailmaat.com",
  location: "Lehi, UT",
  
  // Social media links
  social: {
    instagram: "https://www.instagram.com/what.thegail/",
    github: "#",
    twitter: "#",
  },
  ...
  // SEO and metadata
  seo: {
    keywords: ["portfolio", "design", "development", "creative", "web design"] as string[],
    ogImage: "/og-image.jpg", // You can add this image later
    twitterHandle: "@gailportfolio",
  },
